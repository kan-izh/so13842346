...
/**
 * This {@link com.sun.jersey.server.wadl.WadlGenerator} generates a XML Schema content model based on
...
public class WadlGeneratorJAXBGrammarGenerator implements WadlGenerator {
     ...
     * @param path
     * @return resource
     * @see com.sun.jersey.server.wadl.WadlGenerator#createResource(com.sun.jersey.api.model.AbstractResource, String)
     */
    ...
    public ExternalGrammarDefinition createExternalGrammar() {
        ...
        Map<String, ExternalGrammar> extraFiles =
                new HashMap<String, ExternalGrammar>();
    ...
    private Resolver buildModelAndSchemas(Map<String, ExternalGrammar> extraFiles) {
        ...
        try {
            ...
            context.generateSchema( new SchemaOutputResolver() {
				...
				private final Map<String, String> namingMap = new HashMap<String, String>();
				{
					namingMap.put("http://www.example.com", "anExampleName.xsd");
				}

                @Override
                public Result createOutput( String namespaceUri, String suggestedFileName ) {
                    StreamResult result = new StreamResult( new CharArrayWriter() );
					final String goodName = namingMap.get(namespaceUri);
					result.setSystemId( goodName != null ? goodName : "xsd" + (counter++)  + ".xsd");
                    results.add(result);
                    return result;
                }
            });
